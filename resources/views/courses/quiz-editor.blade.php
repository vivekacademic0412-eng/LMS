        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const refreshQuestionNumbers = () => {
                questionList.querySelectorAll('[data-question-card]').forEach((card, index) => {
                    const badge = card.querySelector('.question-order');
                    if (badge) {
            ...
            const syncPanels = (card) => {
                ...
                const type = typeSelect ? typeSelect.value : 'single_choice';
            ...
            const wireCard = (card) => {
                ...
                const removedLabel = card.querySelector('[data-removed-label]');
                const restoreButton = card.querySelector('[data-question-restore]');
                const removeButton = card.querySelector('[data-question-remove]');

                if (typeSelect) {
                    typeSelect.addEventListener('change', () => syncPanels(card));
                    syncPanels(card);
                }
            ...
            addButton?.addEventListener('click', () => {
                const nextIndex = Number(questionList.dataset.nextIndex || questionList.children.length);
